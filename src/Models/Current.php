...
class Current implements JsonSerializable
{
     ...
     * @maps last_updated_epoch
     * @var integer|null $lastUpdatedEpoch public property
     */
     ...
     * @maps last_updated
     * @var string|null $lastUpdated public property
     */
    public $lastUpdated;
     ...
     * @param integer   $lastUpdatedEpoch Initialization value for $this->lastUpdatedEpoch
     * @param string    $lastUpdated      Initialization value for $this->lastUpdated
    ...
    {
        if (23 == func_num_args()) {
            $this->lastUpdatedEpoch = func_get_arg(0);
            $this->lastUpdated      = func_get_arg(1);
    ...
    {
        $json = array();
        $json['last_updated_epoch'] = $this->lastUpdatedEpoch;
